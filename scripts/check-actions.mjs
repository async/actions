...
const actionDirs = ["setup", "run", "pages", "publish", "preview", "dependabot-merge", "update-train", "dependency-bump", "matrix", "storage", "evidence", "source-impact", "cache", "attest", "doctor", "comment", "agent-evidence", "contract", "hygiene"];
const failures = [];
