...
const actionDirs = ["setup", "run", "pages", "publish", "preview", "dependabot-merge", "matrix", "storage", "evidence", "source-impact", "cache", "attest", "doctor", "comment", "agent-evidence", "contract"];
const failures = [];
